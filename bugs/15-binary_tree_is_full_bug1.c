...
/**
 * This method passes all the checks but I discovered it was not
 * however fail proof.
 * for a skewed binary tree such as
 * 		98
 *             / 
 *           12
 *           /
 *         10
 * it fails. 
 * This is because this binary tree has an odd number for the tree size
 * but it is however not full.
 */
